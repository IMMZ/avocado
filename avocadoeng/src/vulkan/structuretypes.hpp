...
DEFINE_OBJECT_TYPE(DescriptorSet, DESCRIPTOR_SET);
DEFINE_OBJECT_TYPE(Image, IMAGE);
DEFINE_OBJECT_TYPE(ImageView, IMAGE_VIEW);
...
DEFINE_STRUCTURE_TYPE(DescriptorSetLayoutBindingFlagsCreateInfoEXT, DESCRIPTOR_SET_LAYOUT_BINDING_FLAGS_CREATE_INFO_EXT);
DEFINE_STRUCTURE_TYPE(DescriptorSetVariableDescriptorCountAllocateInfoEXT,
...
DEFINE_STRUCTURE_TYPE(ImageMemoryBarrier, IMAGE_MEMORY_BARRIER);
...
DEFINE_STRUCTURE_TYPE(PhysicalDeviceDescriptorIndexingFeatures, PHYSICAL_DEVICE_DESCRIPTOR_INDEXING_FEATURES);
DEFINE_STRUCTURE_TYPE(PhysicalDeviceFeatures2, PHYSICAL_DEVICE_FEATURES_2);
DEFINE_STRUCTURE_TYPE(PipelineColorBlendStateCreateInfo, PIPELINE_COLOR_BLEND_STATE_CREATE_INFO);
DEFINE_STRUCTURE_TYPE(PipelineDepthStencilStateCreateInfo, PIPELINE_DEPTH_STENCIL_STATE_CREATE_INFO);
